...
<template>
    <div class="flex items-center justify-center">
        <div class="relative group leading-7">
            <button @click="isOpen = !isOpen" ref="componentRef" id="dropdown-button" class="text-gray-700 max-md:focus:text-[red] md:text-gray-500 md:hover:text-gray-800 md:hover:bg-zinc-200/60 font-bold py-2 px-2 md:px-4 rounded-md inline-flex items-center">
            ...
            <div v-if="isOpen" ref="excludeRef" id="dropdown-menu" class="absolute right-0 md:right-1/2 md:translate-x-1/2 mt-2 w-max rounded-md shadow-md bg-white ring-1 ring-black ring-opacity-5 p-2 space-y-1 font-jost">
