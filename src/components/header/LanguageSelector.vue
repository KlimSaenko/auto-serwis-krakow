...
<template>
    <div class="flex items-center justify-center">
        <div class="relative group leading-7">
            <button @click="isOpen = !isOpen" ref="componentRef" class="text-gray-700 tracking-wider max-md:active:text-[red] md:text-gray-600 md:hover:text-gray-800 md:hover:bg-zinc-300/60 active:text-gray-800 active:bg-zinc-300/60 py-2 px-2 md:px-4 rounded-md inline-flex items-center duration-150">
                <span :class="`fi-${ getConfigConst(`locales.${locale}.code`) }`" class="fi !bg-cover rounded-full h-5 !w-5 md:h-[1.15rem] md:!w-[1.15rem] mr-3 ring-1 ring-zinc-800/10"></span>
