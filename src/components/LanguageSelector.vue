...
<template>
    <div class="flex items-center justify-center">
        <div class="relative group leading-7">
            ...
            <div v-show="isOpen" class="absolute z-50 right-0 md:right-1/2 md:translate-x-1/2 mt-2 tracking-wide w-max rounded-md shadow-lg bg-white ring-1 ring-zinc-800/10 p-2 space-y-1 font-jost text-zinc-600">
