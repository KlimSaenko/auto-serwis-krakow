...
<template>
    <footer class="border-box bg-zinc-800">
        <div class="pb-5 pt-10 mx-auto text-lg px-8 2xl:px-12 max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg 2xl:max-w-screen-xl font-jost">
            <div class="grid mt-3 text-gray-300 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div class="col-span-1 px-3 mb-5">
                    ...
                    <div class="inline-flex mt-5 gap-7 text-gray-400">
                        <div class="h-7 w-7 group hover:text-gray-100 cursor-pointer">
                            <a>
                            ...
                            <div class="hidden hover:inline-block absolute z-50 px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 ">
                                Tooltip content
                            </div>
                        </div>
                        

                        <span class="h-7 w-7 hover:text-gray-100 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 488 512"><path
            ...
            <span class="block m-2 text-sm text-gray-300 text-center">© 2024 <a href="" class="hover:underline">Krakow Serwis</a>. All Rights Reserved.</span>
        </div>
    </footer>
</template>