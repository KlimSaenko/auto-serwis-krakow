                ...
                <div class="px-3">
                    ...
                    <div class="flex flex-col gap-2.5">
                        <div class="flex items-center">
                            ...
                            <a :href="'tel:' + (getConfigConst('corporateInfo.contactNumber') as string)" target="_blank" draggable="false" class="select-text md:hover:text-zinc-100 active:text-zinc-100">
                        ...
                        <div class="flex items-center">
                            ...
                            <a :href="'mailto:' + (getConfigConst('corporateInfo.email') as string)" target="_blank" draggable="false" class="select-text md:hover:text-zinc-100 active:text-zinc-100">
                                <span class="font-normal">
                    ...
                    <div class="inline-flex mt-8 gap-8 text-gray-400">
                        <a :href="(getConfigConst('corporateInfo.instagramLink') as string)" target="_blank" class="h-7 w-7 group md:hover:text-gray-100 active:text-gray-100 cursor-pointer">
                        ...
                        <a :href="(getConfigConst('corporateInfo.googleMapsLink') as string)" target="_blank" class="h-7 w-7 md:hover:text-gray-100 active:text-gray-100 cursor-pointer">
