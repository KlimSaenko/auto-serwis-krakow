    ...
    <div class="max-h-96 font-jost text-zinc-500">
        <a :href="authorUrl" target="_blank" class="flex group md:hover:bg-zinc-200 active:bg-zinc-200 py-3 px-2 cursor-pointer rounded-xl relative duration-150">
            <div class="flex relative">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 25" class="absolute -bottom-[0.35rem] -right-[0.35rem] h-6 w-6" data-src="https://static.elfsight.com/icons/app-all-in-one-reviews-icons-google-multicolor-stroke.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g clip-path="url(#a-1)"><path fill="#fff" stroke="#fff" stroke-linejoin="round" stroke-width="2" d="M11.8 1.5C5.835 1.5 1 6.335 1 12.3v.4c0 5.965 4.835 10.8 10.8 10.8 5.965 0 10.8-4.835 10.8-10.8v-.4c0-5.965-4.835-10.8-10.8-10.8Z" />
                    ...
                    <path fill="#00AC47" d="M12.004 22.474c2.688 0 4.956-.882 6.608-2.406l-3.213-2.491c-.893.608-2.047.952-3.392.952-2.6 0-4.806-1.754-5.597-4.113H3.095v2.567a9.97 9.97 0 0 0 8.909 5.491Z" /><path fill="#FFBA00" d="M6.407 14.416a5.971 5.971 0 0 1 0-3.817V8.03H3.095a9.977 9.977 0 0 0 0 8.952l3.312-2.567Z" /><path fill="#FC2C25" d="M12.004 6.482a5.417 5.417 0 0 1 3.824 1.494l2.846-2.846a9.581 9.581 0 0 0-6.67-2.593A9.967 9.967 0 0 0 3.095 8.03l3.312 2.57c.787-2.363 2.996-4.117 5.597-4.117Z" />
                </g><defs><clipPath id="a-1"><path fill="#fff" d="M0 0h24v24H0z" transform="translate(0 .5)" /></clipPath></defs></svg>
            </div>
            <div class="ml-4">
                <p class="flex font-jost-bold text-zinc-800 items-center md:group-hover:underline underline-offset-2 leading-5 line-clamp-1">
                    {{ authorName }}
                    <svg class="md:hidden ml-3 min-w-5" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
